...
server.tool(
  "bridge_status",
  `Check if the NeoVision Chrome extension is connected. If not connected, automatically launches Chrome with the extension loaded and waits for it to connect.

Returns connection status. Bridge tools auto-connect — you don't need to call this first.
But it's useful for checking status or triggering a reconnect.`,
  {},
  async () => {
